...
import { AdminWrapper } from "./components/auth/AdminWrapper.tsx";
...
export const router: RouteObject[] = [
    ...
    {
        path: "admin",
        element: <AdminWrapper />, // Protected admin layout
        errorElement: <ErrorPage />,
        async lazy() {
    ...
    {
        path: "/odysseia",
        element: <OdysseiaRoot />,
        errorElement: <ErrorPage />,
        children: [
            {
                path: "",
                async lazy() {
                    const OdysseiLanding = await import("./pages/OdysseiLanding");
                    return { Component: OdysseiLanding.default };
                },
            },
            {
                path: "admin",
                ...
                children: [
                    {
                        path: "",
                        async lazy() {
                            const OdysseiAdmin = await import("./pages/OdysseiLanding/Admin");
                            return { Component: OdysseiAdmin.default };
                        },
                    }
                ]
            }
