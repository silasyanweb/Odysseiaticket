...
import "../../../pages/OdysseiLanding/OdysseiaTheme.css";
...
const EventHomepage = ({...loaderData}: EventHomepageProps) => {
    ...
    const isOdysseia = event.id === 1 || event.id?.toString() === "1";
    ...
    return (
        <>
            ...
            <main
                className={classNames(classes.pageWrapper, isOdysseia && "odysseia-theme")}
                style={themeStyles}
